function CreateWhatsappChatWidget(option = {
    ...
    function initWidget(){
        ...
        jQuery('body').append(`<div id="whatsapp_chat_widget">
            <div id="wa-widget-send-button">
                ...
                <div style="color: var(--bg-color); font-size: 18px">${option.chatButtonSetting.ctaText}</div>
            </div>
        </div>`);
        jQuery('#whatsapp_chat_widget').append(`
            <div class='wa-chat-box'>
                ...
                <div class='wa-chat-box-send'>
                    ...
                    <div class='wa-chat-box-poweredby'>WhatsApp by <a href="#" target="_blank" style="color: #006eff6e;">ArtexSol</a></div>
                </div>
            </div>
        `);
    ...
    var styles = `
        ...
        #wa-widget-send-button {
            margin: 0px -4px 65px 0px !important;
